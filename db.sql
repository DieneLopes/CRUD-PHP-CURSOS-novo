...
INSERT INTO tb_user (name,email,password,profile)
VALUES ('admin','admin@email.com','','admin');

INSERT INTO tb_alunos 
(nome, matricula, email, status, genero, dataNascimento, cpf)
VALUES
('Nenem', '1234123', 'nenem@email.com', true, 'Felino', '2001-09-12', '12312312312'),
('Lobinho', '4434123', 'chiquim@email.com', true, 'Felino', '2000-12-31', '44455588812'),
